...
if($passs1==$passs2 )
{
	$sql="insert into faculty(Faculty_Name,Faculty_Id,Department,Contact,Email,Password)values('".$_POST['fn']."','".$_POST['fid']."','".$_POST['dep']."','".$_POST['ph']."','".$_POST['email']."','".$_POST['password']."')";
