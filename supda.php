...
echo"</style></head>";
	...
	echo"<center><link rel='stylesheet' href='create_files/formoid1/formoid-default.css' type='text/css' />";
...
echo"<label class='title'>Phone Number</label>";
	echo"<input type='text' name='ph' pattern='[+]?[\.\s\-\(\)\*\#0-9]{10,}' maxlength='10 value='".$row['Contact']."' /></div>";
