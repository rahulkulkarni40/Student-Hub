...
$insert=mysql_query("insert into question_papers(name,id,sem,Subject,Year)values('$name','$id','".$_POST['sem']."','".$_POST['sub']."','".$_POST['year']."')");
if($insert){
...
<th>Subject</th><th><input type="text" name="sub" required></th>
<th>Year</th><th><input type="text" name="year" required></th>
<tr>
...
<center>Click to Download</center>
<tr>
...
<?php
$select=mysql_query("select * from question_papers order by sem asc");
...
<td><center><?php echo $sub;?></center></td>
